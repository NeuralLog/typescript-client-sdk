...
import {
  ...
  ApiKeyService,
  KEKService as OpenApiKEKService
} from './openapi';

/**
 * Service for interacting with the NeuralLog auth service using the OpenAPI generated client
 */
export class ComposedOpenApiAuthService {
  private authService: AuthenticationService;
  private apiKeyService: ApiKeyService;
  private kekService: OpenApiKEKService;
  private baseUrl: string;

  /**
   * Create a new ComposedOpenApiAuthService
   *
  ...
  constructor(baseUrl: string, apiClient: AxiosInstance) {
    ...
    this.kekService = new OpenApiKEKService(baseUrl, apiClient);
  }
